...
// Frontend only uses Envoy SDS (Pattern 1)
const (
...
// NewLogger creates a new structured logger for the frontend component
func NewLogger(component string) *Logger {
	// Determine log format from environment (default: JSON for FR-019)
...
func (l *Logger) LogHTTPRequest(ctx context.Context, method, path string, statusCode int, duration string) {
	l.logger.InfoContext(ctx,
		"HTTP request",
		"component", l.component,
		"event", EventHTTPRequest,
		"method", method,
		"path", path,
